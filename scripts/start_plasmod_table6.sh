...
screen -dmS "${SESSION_NAME}" bash -lc "
  ...
  env \
    ...
    PLASMOD_CONSISTENCY_DEFAULT_MODE='${PLASMOD_CONSISTENCY_DEFAULT_MODE:-strict_visible}' \
    PLASMOD_CONSISTENCY_BOUNDED_MAX_LAG='${PLASMOD_CONSISTENCY_BOUNDED_MAX_LAG:-1s}' \
    PLASMOD_CONSISTENCY_WORKERS='${PLASMOD_CONSISTENCY_WORKERS:-10}' \
    PLASMOD_CONSISTENCY_QUERY_TIMEOUT='${PLASMOD_CONSISTENCY_QUERY_TIMEOUT:-30s}' \
    PLASMOD_VISIBILITY_ONLY=1 \
